...
if res ~= 200 then
print('\27[0;31mٴ≪┉ ┉ ┉ ┉ ┉ ᴹᴱᴰᴼ ┉  ┉ ┉ ┉ ┉≫ٴ\n التوكن غير صحيح تاكد منه ثم ارسله')
else
io.write('\27[0;31m تم حفظ التوكن بنجاح \naٴ≪┉ ┉ ┉ ┉ ┉ ᴹᴱᴰᴼ ┉  ┉ ┉ ┉ ┉≫ٴ\n27[0;39;49m')
database:set(id_server..":token",token)
end 
else
print('\27[0;35mٴ≪┉ ┉ ┉ ┉ ┉ ᴹᴱᴰᴼ ┉  ┉ ┉ ┉ ┉≫ٴ ┉\n لم يتم حفظ التوكن ارسل لي التوكن الان')
end 
...
sudo_users = {SUDO,1118246568,16076569}   
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"🎼┇𝗌𝗈𝗎𝗋𝖼𝖾𝗌 𝗆𝖾𝖽𝗈.")  
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '🖨┇𝗌𝗈𝗎𝗋𝖼𝖾𝗌 𝗆𝖾𝖽𝗈.',url="t.me/TEM_MAX"}},
}
local msg_id = msg.id_/2097152/0.5
...
{
{text = '𝐃𝐑𝐀𝐆𝐎𝐍 𝐂𝐇𝐀𝐍𝐍𝐄𝐋', url="t.me/TEM_MAX"},
},
}
local msg_id = msg.id_/2097152/0.5
...
send(msg.chat_id_, msg.id_, t..'ٴ≪┉ ┉ ┉ ┉ ┉ ᴹᴱᴰᴼ ┉  ┉ ┉ ┉ ┉≫ٴٴ\n℘︙ ➫ .[🖨┇𝗌𝗈𝗎𝗋𝖼𝖾𝗌 𝗆𝖾𝖽𝗈. ](t.me/TEM_MAX)➤ ')
end
